...
SECRET_KEY = '&u_8%pzyb-ds8nc_+cd3(-+%&ih9(+!x_94%tv%a#d5-8*wbh&'
...
INSTALLED_APPS = [
    ...
    'guardian',
    'corsheaders',
    'posters_app.apps.PostersAppConfig',
    ...
    'soundbytes_app.apps.SoundbytesAppConfig',
    'stories_app.apps.StoriesAppConfig',
